      ...
      <main className="mx-auto max-w-[900px] px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-sm prose-invert max-w-none space-y-8 text-sm leading-relaxed text-foreground/80">
          ...
          <section>
            ...
            <p>
              These Terms of Service (&ldquo;Terms&rdquo;) constitute a legally binding agreement between you (&ldquo;User&rdquo;, &ldquo;you&rdquo;, or &ldquo;your&rdquo;) and <strong className="text-foreground">IPEK TECH LLC</strong>, a Wyoming limited liability company (&ldquo;Company&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;), governing your access to and use of the OpenFrame platform, available at open-frame.net (the &ldquo;Service&rdquo;).
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p className="mt-3">
              You agree to notify us immediately at <a href="mailto:info@open-frame.net" className="text-primary hover:underline">info@open-frame.net</a> of any unauthorized use of your account. We are not liable for any losses arising from unauthorized use of your account.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              You retain all ownership rights to the content you upload or create through the Service (&ldquo;User Content&rdquo;). By uploading User Content, you grant us a limited, non-exclusive, royalty-free license to store, process, and display your User Content solely to provide the Service to you.
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p>
              We reserve the right to modify these Terms at any time. We will notify you of material changes by posting the updated Terms on this page and updating the &ldquo;Last updated&rdquo; date. Your continued use of the Service after any changes constitutes your acceptance of the new Terms.
            </p>
          </section>
