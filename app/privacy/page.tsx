      ...
      <main className="mx-auto max-w-[900px] px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-sm prose-invert max-w-none space-y-8 text-sm leading-relaxed text-foreground/80">
          ...
          <section>
            ...
            <p>
              <strong className="text-foreground">IPEK TECH LLC</strong> (&ldquo;Company&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;), a Wyoming limited liability company, operates the OpenFrame platform at open-frame.net (the &ldquo;Service&rdquo;). This Privacy Policy explains how we collect, use, share, and protect information about you when you use our Service.
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p className="mt-3">
              To exercise these rights, contact us at <a href="mailto:info@open-frame.net" className="text-primary hover:underline">info@open-frame.net</a>. We will respond within a reasonable timeframe.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              The Service is not directed to individuals under the age of 18. We do not knowingly collect personal information from minors. If you believe we have inadvertently collected information from a minor, please contact us immediately at <a href="mailto:info@open-frame.net" className="text-primary hover:underline">info@open-frame.net</a> and we will take steps to delete such information.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We may update this Privacy Policy from time to time. We will notify you of material changes by posting the updated policy on this page and updating the &ldquo;Last updated&rdquo; date. Your continued use of the Service after changes constitutes acceptance of the updated policy.
            </p>
          </section>
